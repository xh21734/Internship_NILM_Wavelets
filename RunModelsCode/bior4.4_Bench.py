...
save_path = "/user/work/xh21734/Intern/Data/DWT/bior4.4 level 12/"
general_report_path = "/user/work/xh21734/Intern/Reports/DWT/bior4.4 level 12/"
...
print(train_labels_reshaped)

print(test_data_reshaped)
print(test_labels_reshaped)
